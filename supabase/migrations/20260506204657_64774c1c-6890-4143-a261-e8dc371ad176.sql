-- Make new curator deal songs enter the bot queue immediately with a 1-minute polling interval.
...
-- Bring existing open auto-collect songs back to the near-term queue.
