...
export default function PlaylistDeals() {
  ...
  const { deals, logs, playlists, songs, alerts, curators, balances, progressByDeal, loading, deleteDeal, addLog, addBaseline, insertSnapshots, closeDeal, reopenDeal, forceCollectNow, updateCurator, archiveCurator, deleteCurator, reload } = useCuratorDeals();
