          ...
          overview: (
            <div className="space-y-6">
              <CampaignGatesCard
                ...
                campaignType={(camp as any).campaign_type ?? null}
