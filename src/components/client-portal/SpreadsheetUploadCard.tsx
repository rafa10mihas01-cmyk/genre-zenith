    ...
    <Card className="border-border/60 bg-card overflow-hidden">
      <CardContent className="p-4 sm:p-5 space-y-4 min-w-0">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
          ...
          <div className="shrink-0 rounded-lg border border-border/60 bg-muted/20 px-3 py-2 flex items-center justify-between gap-3 sm:flex-col sm:items-end sm:justify-start sm:text-right sm:min-w-[120px]">
