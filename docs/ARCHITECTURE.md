...
|---|---|---|
| `campaigns.total_delivered` | `curator_deal_snapshots` (soma de plays por deal/data) | Trigger no insert/update de snapshots; também recalculado por `cron-reconcile-curator-deals`. |
